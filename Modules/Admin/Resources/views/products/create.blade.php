...
<div class="body d-flex py-3">
    <div class="container-fluid">
        <form action="{{ Route('admin.product.store') }}" method="POST" name="" enctype="multipart/form-data" id="formAddProduct">
            @csrf
            <div class="row align-items-center">
                <div class="border-0 mb-4">
                    <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                        <h3 class="fw-bold mb-0">Products Add</h3>
                        <button type="submit" class="btn btn-primary btn-set-task w-sm-100 py-2 px-5 text-uppercase button-submit-add-product">Save</button>
                    </div>
                </div>
            </div> <!-- Row end  -->
                                    ...
                                    {{--  <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <div class="dropify-wrapper">
                                                ...
                                                <input type="file" name="images" id="input-file-to-destroy" class="dropify" data-allowed-formats="portrait square" data-max-file-size="2M" data-max-height="2000">
